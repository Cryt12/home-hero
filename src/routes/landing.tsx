  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        <div className="grid gap-4 md:grid-cols-3">
          {[
            { name: "Aarav S.", quote: "Booked a deep clean in under 2 minutes. Pro showed up on time." },
            { name: "Liza R.", quote: "Fixed my AC same day. Pricing was upfront, no surprises." },
            { name: "Marco D.", quote: "Best handyman experience I've had. Bookmarked for life." },
          ].map((t) => (
